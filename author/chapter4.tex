...
We are going to turn the refutation from $F_{x_i = 0}$ to a \textbf{derivation} of $x_i$ from $F$.
...
Now consider what happens to $F = F_1 \cup F_2 \cup F_3$ in $F_{x_i := 0}$:
...
\begin{enumerate}
    ...
    \begin{itemize}
        \item So in $F_{x_i := 0}$, this clause becomes True and is deleted.
    \end{itemize}
