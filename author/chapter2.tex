...
\begin{proof}[Proof of \Cref{thm:razborov} monotone circuit lower bound from \Cref{lem:new-false-positives} and \Cref{lem:new-false-negatives}]
\
...
We are now ready to conclude the proof of \Cref{thm:razborov}.
